...
;START #####################################################
    ...
    call _display_help      ; call the help
	call _display_space
...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to JOSH Ver 0.01", 0x00
	...
	strTest			db	"Modified by Thilina Pahalagedara", 0x00
